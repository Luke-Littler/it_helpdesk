...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference("Equipment.count") do
      post equipment_index_url, params: { equipment: { make: @equipment.make, model: @equipment.model, serial_number: @equipment.serial_number } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { make: @equipment.make, model: @equipment.model, serial_number: @equipment.serial_number } }
