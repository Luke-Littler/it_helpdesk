...
class SpecialistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialist" do
    assert_difference("Specialist.count") do
      post specialists_url, params: { specialist: { email: @specialist.email, name: @specialist.name, phone: @specialist.phone } }
    end
  ...
  test "should update specialist" do
    patch specialist_url(@specialist), params: { specialist: { email: @specialist.email, name: @specialist.name, phone: @specialist.phone } }
